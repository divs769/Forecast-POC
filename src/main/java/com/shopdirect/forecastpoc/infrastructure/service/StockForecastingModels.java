...
public class StockForecastingModels {
    ...
    public static Stream<ProductStockData> naivePrediction(Stream<ProductStockData> historicData, Stream<LocalDate> datesToPredict){
    ...
    public static Stream<ProductStockData> averagePrediction(Stream<ProductStockData> historicData, Stream<LocalDate> datesToPredict){
    ...
    private static Stream<ProductStockData> repeatValueOnProductStockDates(Stream<LocalDate> datesToPredict, long stockValue) {
